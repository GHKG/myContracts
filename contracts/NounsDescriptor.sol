...
contract NounsDescriptor is INounsDescriptor, Ownable {
    ...
    // Noun Trees (Custom RLE)
    bytes[] public override trees;
    ...
    function addTree(bytes calldata _tree) external{
        trees.push(_tree);
    }
     ...
     */
    function addManyBackgrounds(string[] calldata _backgrounds) external  onlyOwner {
