...
import "./ArkreenTokenV1.sol";

import "@openzeppelin/contracts-upgradeable/utils/AddressUpgradeable.sol";
import "@openzeppelin/contracts/utils/cryptography/ECDSA.sol";

contract ArkreenRewardV2 is 
        ContextUpgradeable,
        OwnableUpgradeable, 
        PausableUpgradeable,
        UUPSUpgradeable
{
    ...
    ArkreenTokenV1              public ERC20Contract;
        ...
        initializer
    {
        ...
        ERC20Contract = ArkreenTokenV1(tokenAKRE);
    ...
    function setERC20ContractAddress(address addr)public onlyOwner{
        ...
        ERC20Contract = ArkreenTokenV1(addr);
    }
    ...
    //new function added to version 2
    function hehe() external pure returns(string memory){
        return 'hehehehe';
    }
