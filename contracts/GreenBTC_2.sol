...
contract GreenBTC_2 is Ownable,ERC721{
    ...
    address public _arkreenBuilder = 0xA05A9677a9216401CF6800d28005b227F7A3cFae;
    address public _tokenNative = 0x9c3C9283D3e44854697Cd22D3Faa240Cfb032889;
    address public _tokenART = 0x0999AFb673944a7B8E1Ef8eb0a7c6FFDc0b43E31;
    ...
    function _mintNFT(Green_BTC calldata gbtc) internal {
        ...
        _mint(msg.sender, gbtc.height);
        _data[gbtc.height] = green_btc;
    }



    function _authVerify(Green_BTC calldata gbtc, Sig_PARAM calldata sig) public view {
    ...
    function authMintGreenBTC(Green_BTC calldata gbtc, Sig_PARAM calldata sig, BadgeInfo calldata badgeInfo, uint256 deadline) public  payable ensure(deadline) {
        ...
        // uint256 amountART = 2*10**9;//两个ART，需要0.1个matic 即 10**17 wei
        uint256 amountART = msg.value * (10**9) / 50000000000000000;
